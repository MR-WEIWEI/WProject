...
class AddMorePersonVC: BaseViewController, UITableViewDataSource, UITableViewDelegate {
...
extension AddMorePersonVC {
    ...
    func tableView(_ tableView: UITableView, viewForFooterInSection section: Int) -> UIView? {
        ...
        addNextBtn.setTitleColor(UIColor(red: 77/255.0, green: 77/255.0, blue: 77/255.0, alpha: 1), for: .normal)
        ...
        nextStepBtn.setTitleColor(UIColor(red: 77/255.0, green: 77/255.0, blue: 77/255.0, alpha: 1), for: .normal)
