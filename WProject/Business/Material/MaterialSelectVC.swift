...
class MaterialSelectVC: BaseViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @IBAction func ensureBtnClicked(_ sender: Any) {
        ...
        self.navigationController?.pushViewController(MaterialBuyVC(), animated: true)
    }
}
