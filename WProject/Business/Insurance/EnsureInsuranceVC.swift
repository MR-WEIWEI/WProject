...
class EnsureInsuranceVC: BaseViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @IBAction func wechatPayBtnClicked(_ sender: Any) {
    ...
    @IBAction func alipayBtnClicked(_ sender: Any) {
        ...
        self.pushToViewController(ValidInsuranceOrderVC())
    }
